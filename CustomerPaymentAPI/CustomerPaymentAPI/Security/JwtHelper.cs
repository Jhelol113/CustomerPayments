...
{
    // =====================================================================
    // TUTOR IA: JWT HELPER — GENERADOR DE TOKENS JWT
    // =====================================================================
    ...
    //
    // ¿Qué es un JWT?
    // JSON Web Token es un estándar (RFC 7519) para transmitir información
    // de forma segura entre un servidor y un cliente. El token está firmado
    // digitalmente, lo que permite al servidor verificar su autenticidad
    // sin necesidad de consultar la base de datos en cada petición.
    //
    // Estructura del JWT: HEADER.PAYLOAD.SIGNATURE
    // ─────────────────────────────────────────────
    // HEADER:    { "alg": "HS256", "typ": "JWT" }
    // PAYLOAD:   { "nameid": "1", "unique_name": "admin", "role": "Admin", "exp": ... }
    // SIGNATURE: HMACSHA256(base64(header) + "." + base64(payload), secretKey)
    //
    // El frontend almacena este token (generalmente en localStorage) y lo
    // envía en cada petición HTTP en el header:
    ...
    public class JwtHelper
    {
        ...
        // TUTOR IA: Inyectamos IConfiguration para leer las claves JWT
        ...
        // =====================================================================
        // TUTOR IA: Este método se invoca desde AuthService después de verificar
        ...
        {
            // TUTOR IA: Leemos la sección "JwtSettings" de appsettings.json.
            ...
            // TUTOR IA: La clave simétrica se usa para FIRMAR y VERIFICAR el token.
            ...
            // TUTOR IA: Los Claims son las "declaraciones" sobre el usuario
            ...
            // por cualquiera (está en Base64, NO está encriptado, solo FIRMADO).
            var claims = new[]
            {
            ...
            // TUTOR IA: Calculamos la fecha de expiración usando UTC (tiempo universal)
            ...
            // TUTOR IA: Construimos el token con todos los componentes.
            ...
            // TUTOR IA: WriteToken serializa el JwtSecurityToken a un string
