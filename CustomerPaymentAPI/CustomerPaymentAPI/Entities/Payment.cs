...
namespace CustomerPaymentAPI.Entities
{
    public class Payment
    {
        ...
        // CustomerId actuará como una Clave Foránea (Foreign Key) 
        // vinculando este pago a un cliente específico en la tabla Customers.
        public int CustomerId { get; set; }

        // [Column] especifica el tipo exacto en SQL.
        ...
        // [ForeignKey] indica explícitamente a qué propiedad foránea está ligada esta relación N:1.
        // Esto permite navegar desde un Payment hacia los datos de su Customer asociado.
        [ForeignKey("CustomerId")]
        public Customer Customer { get; set; }

        // [NotMapped] le dice a Entity Framework que NO intente crear una columna para esta propiedad en la base de datos.
